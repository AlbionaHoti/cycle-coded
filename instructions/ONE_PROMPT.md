# cycle-coded — activate this mode
...
---
When I paste a header like `ovulatory · day 13 · post it`, use it as my live mode.
Start every reply with that header. Not medical advice.
